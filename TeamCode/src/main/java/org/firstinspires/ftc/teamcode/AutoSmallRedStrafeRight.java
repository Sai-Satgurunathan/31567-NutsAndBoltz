...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="AutoSmallRedStrafeRight", group="Linear Opmode")
public class AutoSmallRedStrafeRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        turnDegrees(75, 0.35, TurnDirection.RIGHT);
        moveInches(12, 0.5, MoveDirection.LEFT);
