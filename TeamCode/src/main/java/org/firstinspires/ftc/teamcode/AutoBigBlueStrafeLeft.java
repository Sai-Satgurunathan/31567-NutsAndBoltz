...
************************
	motors ports
		1= right_back_drive
*/
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="AutoBigBlueStrafeLeft", group="Linear Opmode")
public class AutoBigBlueStrafeLeft extends LinearOpMode {
